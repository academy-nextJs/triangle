...
const HeroSection = () => {
  ...
  return (
<<<<<<< HEAD
    <div className="flex max-w-[1280px] items-center justify-around  mt-9">
...
>>>>>>> fa6318a701e04888e653eba03cbebc3caf5804a3
      </div>
      <div className=" mx-auto h-auto absolute top-[11%] transform -translate-y-1/2 px-4">
  <div className="flex flex-col items-center w-full">
    <div className="w-full bg-white rounded-2xl shadow-md p-4 md:p-6 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-2 relative">
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="w-[162px] h-[48px] justify-start pl-10 pr-3 relative text-gray-400">
                <RxCalendar className="absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                <span className="text-[14px]">{endDate ? format(endDate, "yyyy/MM/dd") : "انتخاب تاریخ"}</span>
              </Button>
            </PopoverTrigger>
        ...
        <div className="flex items-center gap-2 relative">
          <Popover>
            <PopoverTrigger asChild>
              <Button variant="outline" className="w-[162px] h-[48px] justify-start pl-10 pr-3 relative text-gray-400">
                <RxCalendar className="absolute right-3 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400" />
                <span className="text-[14px] text-right">{startDate ? format(startDate, "yyyy/MM/dd") : "انتخاب تاریخ"}</span>
              </Button>
            </PopoverTrigger>
            <PopoverContent className="w-auto p-0">
