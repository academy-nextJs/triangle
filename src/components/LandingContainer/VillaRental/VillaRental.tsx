...
const VillaRental = () => {
  ...
  return (
    <div className="px-4 py-6 max-w-7xl mx-auto ">
      ...
      <div className="hidden [@media(min-width:1100px)]:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
  {destinations.map((dest) => (
    ...
    >
      ...
      <div className="flex flex-row mb-3 justify-between mx-6">
        <div
          dir="rtl"
          className="text-center text-sm dark:text-gray-800 font-[IranYekanRegular] font-semibold text-[#848484]"
        >
          (50 مورد)
        </div>
      ...
      {destinations.map((dest) => (
        ...
        >
          <div className=" dark:bg-blue-300  rounded-4xl dark:border-none borde bg-white  border border-[#EAEAEA] shadow-sm overflow-hidden">
            ...
            <div className="flex flex-row mb-3 justify-between mx-6">
              <div className="text-center text-sm dark:text-gray-800 font-[IranYekanRegular] font-semibold text-[#848484]">
          (50 مورد)
              </div>
              <div className="text-center text-base font-semibold font-[IranYekanRegular] text-[#1E1E1E]">
                {dest.area_name}
